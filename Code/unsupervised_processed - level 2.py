...
def pred_idx(distances):
    highest=np.argmin(distances)
    h=distances[highest]
    distances[highest]=100000
    s_highest=np.argmin(distances)
    distances[highest]=h
    return [highest, s_highest]
...
for i in range(len(predicted)):
  answer_cos.append(predicted.loc[i,'original_sentences'][predicted.loc[i,'pred_idx_cos'][0]]+predicted.loc[i,'original_sentences'][predicted.loc[i,'pred_idx_cos'][1]])
  answer_euc.append(predicted.loc[i,'original_sentences'][predicted.loc[i,'pred_idx_euc'][0]]+predicted.loc[i,'original_sentences'][predicted.loc[i,'pred_idx_euc'][1]])
  ques.append(predicted.loc[i,'questions'])
  cosine.append([predicted.loc[i,'cosine_sim'][predicted.loc[i,'pred_idx_cos'][0]], predicted.loc[i,'cosine_sim'][predicted.loc[i,'pred_idx_cos'][1]]])
  euc.append([predicted.loc[i,'euclidean_dis'][predicted.loc[i,'pred_idx_euc'][0]],predicted.loc[i,'euclidean_dis'][predicted.loc[i,'pred_idx_euc'][1]]])
...
df.to_csv(r'..\Results\Grade5_Answers_level2.csv')